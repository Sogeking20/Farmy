            ...
            <div className="px-[50px] mt-[50px]">
                ...
                <div className="flex flex-col md:flex-row gap-[30px] md:gap-5">
                    ...
                    <div className="md:w-[50%] text-center">
                        ...
                        <a href="/signup"><button className="w-[188px] h-[50px] mt-2 mb-7 px-5 py-3 bg-[#F4991A] font-bold text-white rounded-sm border border-[#F4991A]"><UserOutlined /> Register now!</button></a>
                        <p className="w-[100%] border-t"><span className="relative top-[-14px] bg-white px-[7px]">Login or Signup through:</span></p>
                        <button className="w-[188px] h-[50px] mt-2 px-5 py-3 bg-[#3B5998] font-bold text-white rounded-sm border"><UserOutlined /> Facebook</button>
                    </div>
                </div>
            </div>
            <div className="px-[50px] mt-[50px]">
                <h3 className="text-[24px] text-[#107433] font-bold mb-5">New Products</h3>
                ...
                <div className="flex flex-col w-[100%] mt-[40px] items-center">
                    <button className="border w-[160px] text-white h-[50px] bg-[#F4991A] rounded-sm font-bold">Show more</button>
                    <div className="w-[70%] flex flex-col gap-5 items-center md:flex-row md:justify-between text-[12px] mt-[60px]">
                        <button className="border w-[120px] text-white h-[40px] bg-[#F4991A] rounded-sm font-bold">Fruit & Vegetables</button>
                        <button className="border w-[100px] text-white h-[40px] bg-[#F4991A] rounded-sm font-bold">Meat & Fish</button>
                    </div>
                </div>
            </div>
