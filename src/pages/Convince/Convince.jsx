    ...
    return (
        <div className="max-w-[940px] w-[100%] mx-auto px-5">
            ...
            <div className="w-[100%] mt-[50px]">
                ...
                <button className="w-[115px] h-[40px] bg-[#F4991A] text-white font-bold rounded-sm"><a href="/farm-shop">Try now</a></button>
            </div>
            <div className="w-[100%] mt-[50px] flex flex-col items-center">
                ...
                <div ref={FreshProduce} className="w-[100%] mb-[50px]">
                    ...
                    <button className="w-[215px] h-[40px] bg-[#F4991A] text-white font-bold rounded-sm"><a href="/farm-shop">To the Online Market</a></button>
                </div>
                <img className='mb-5' src={svg1} alt="qwe" />
                <div ref={MoreTransparency} className="w-[100%] mb-[50px]">
                    ...
                    <button className="w-[260px] h-[40px] bg-[#F4991A] text-white font-bold rounded-sm"><a href="https://eggandplant.farmy.ch/?s=producer">Get to know our producers</a></button>
                </div>
                <img className='mb-5' src={svg2} alt="qwe" />
                <div ref={FromSwitzerland} className="w-[100%] mb-[50px]">
                    ...
                    <button className="w-[215px] h-[40px] bg-[#F4991A] text-white font-bold rounded-sm"><a href="/farm-shop">From Switzerland</a></button>
                </div>
                <img className='mb-5' src={svg3} alt="qwe" />
                <div ref={OurOrganicProducts} className="w-[100%] mb-[50px]">
                    ...
                    <button className="w-[215px] h-[40px] bg-[#F4991A] text-white font-bold rounded-sm"><a href="/farm-shop">Our organic</a></button>
                </div>
                <img className='mb-5' src={svg4} alt="qwe" />
                <div ref={OurLoyaltyProgram} className="w-[100%] mb-[50px]">
                    ...
                    <div className="flex gap-3">
                        <button className="px-5 h-[50px] bg-[#F26F00] text-white font-bold rounded-3xl"><a href="/sign-up">Register</a></button>
                        <button className="px-5 h-[50px] bg-[#F26F00] text-white font-bold rounded-3xl"><a href="/login">View Bonus-Eggs</a></button>
                    </div>
                </div>
                <img className='mb-5' src={svg5} alt="qwe" />
                <div ref={DailyEnvironmentalProtection} className="w-[100%] mb-[50px]">
                    ...
                    <button className="w-[215px] h-[40px] bg-[#F4991A] text-white font-bold rounded-sm mt-[30px]"><a href="/farm-shop">Environmental protection</a></button>
                </div>
                <img className='mb-5' src={svg6} alt="qwe" />
                <div ref={AboutUs} className="w-[100%] mb-[100px]">
                    ...
                    <button className="w-[215px] h-[40px] bg-[#F4991A] text-white font-bold rounded-sm"><a href="about-us">About us</a></button>
                </div>
