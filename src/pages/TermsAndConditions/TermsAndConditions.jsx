export default function TermsAndConditions() {
    return(
        <div className="container text-[12px] text-start" rows="5">
        <h1 className="text-[24px] font-bold mt-[30px]">GENERAL TERMS AND CONDITIONS</h1>
        <h3 className="text-[18px] font-semibold" id="scope-of-application">1. SCOPE OF APPLICATION</h3>
        <p className="text-[16px] mb-[5px]">This online shop is run by Farmy AG, Buckhauserstrasse 28, 8048 Zurich.</p>

        <p className="text-[16px] mb-[5px]">These terms and conditions apply in the time the contract was amended for all business relations between Farmy (hereinafter we or us) and their customers (you).</p>

        <p className="text-[16px] mb-[5px]">These terms are deemed to have been accepted when ordering goods or services. Differing conditions require written confirmation from us.</p>

        <h3 className="text-[18px] font-semibold" id="compatibility">2. COMPATIBILITY</h3>
        <p className="text-[16px] mb-[5px]">The presentation of products in the online shop is not a legally-binding resolution, but merely represents a non-binding online catalog. Just putting products in the “basket” is not considered a binding order. A binding order for the products contained in the basket is only completed and valid when clicking the “Order” button on the order page. We will then send you an immediate contract confirmation via e-mail, with the receipt of the contract. 
        ...
        <p className="text-[16px] mb-[5px]">Minimum order value: 						First order CHF 50 / From the second order CHF 79</p>

        <p className="text-[16px] mb-[5px]">Information on delivery costs is currently being adjusted.</p>

        <p className="text-[16px] mb-[5px]">The stated price applies for all deliveries incl. the applicable VAT. The delivery slots here above can be adapted depending on season or order volume. The delivery slots effectively open and available are shown at check-out.</p>

        <p className="text-[16px] mb-[5px]"><strong>Minimum ORDER VALUE SURCHARGE</strong></p>

        <p className="text-[16px] mb-[5px]">For orders from the minimum order value of CHF 80 up to an order value of CHF 100 we charge a minimum order surcharge of CHF 7.90. The minimum order surcharge applies to all zones and is waived as soon as the value of the order exceeds CHF 100 or if you are in possession of a Hofpass, until it expires.</p>

        <h3 className="text-[18px] font-semibold" id="farmy-box-conditions"><strong>3.1“Farmy Box” conditions</strong></h3>

        <p className="text-[16px] mb-[5px]">By ordering products at Farmy.ch that are delivered in “Farmy Boxes”, the customer agrees to pay 10 CHF per box if damaged or customer wishes not to return the “Farmy Box/es”. In this case the customer automatically becomes the owner of the “Farmy Box/es”.</p>

        <p className="text-[16px] mb-[5px]">The “Farmy Box/es” must be returned to Farmy AG within 1 month of delivery. After the stipulated period, Farmy AG renounces the restitution of the “Farmy Boxes” and invoices the customer the value of every “Farmy Box” sent. The CHF 5 deposit will be kept and deducted from the total invoiced amount.</p>

        <p className="text-[16px] mb-[5px]"><strong>3.1.2 Deposit</strong></p>

        <p className="text-[16px] mb-[5px]">A) The CHF 5 deposit does not cover the cost of the unreturned “Farmy Boxes”.</p>

        <p className="text-[16px] mb-[5px]">B) The deposit of CHF 5 is kept to cover the Swiss Post pickup service if that should happen.</p>

        <p className="text-[16px] mb-[5px]">C) The deposit will be deducted from any invoice for the unreturned “Farmy Boxes”.</p>

        <p className="text-[16px] mb-[5px]">D) Deposit reimbursements will be applied to the customer’s account balance at Farmy. Reimbursement to credit card/Paypal/Twint may be done upon written request at service@farmy.ch.</p>

        <p className="text-[16px] mb-[5px]"><strong>3.1.3 Return process</strong></p>

        <p className="text-[16px] mb-[5px]">1 month after the order, Farmy AG will send a reminder e-mail to the customer with several options to return the “Farmy Boxes”. If the “Farmy Boxes” are then not returned, Farmy will automatically apply its right to renounce the restitution of the “Farmy Boxes” and will claim the full value (CHF 10 per box minus the CHF 5 deposit already paid). The invoice will be sent and handled fully by our invoicing partner CembraPay AG.</p>

        <p className="text-[16px] mb-[5px]"><strong>A-Farmy Pickup:</strong> “Farmy Boxes” may be given back anytime to our delivery service. Customers may give it to the courier or leave it in their milk box or under or above mailboxes on the day of a delivery. The deposit will be reimbursed as soon as it is picked by the courier (Delivery zone A &amp; B).</p>

        <p className="text-[16px] mb-[5px]"><strong>B-Drop bags at Farmy warehouse:</strong> Customers may return the “Farmy Boxes” directly to our warehouse and receive the deposit refund on your Farmy Account balance</p>

        <p className="text-[16px] mb-[5px]"><strong>C-Home pickup by Swiss Post:</strong></p>

        <p className="text-[16px] mb-[5px]">A) At any time, the customer may return the “Farmy Boxes” through Swiss Post. Customers need to leave the “Farmy Boxes” in their open milk box or under or above mailboxes, following the process instructions www.farmy.ch/box</p>

        <p className="text-[16px] mb-[5px]">B) Farmy retains the right to charge an extra Swiss Post pick up cost if the customer does not follow the return instructions properly.</p>

        <p className="text-[16px] mb-[5px]">C) When choosing this option, the customer agrees that the deposit of CHF 5 is not refunded and will be transferred to Swiss Post to cover the pickup services.</p>

        <p className="text-[16px] mb-[5px]">D) Farmy will fully validate the returned “Farmy Boxes” within 4 weeks after pick-up by Swiss Post. Farmy retains the right to claim/invoice unreturned boxes during this period.</p>

        <h3 className="text-[18px] font-semibold" id="retention-of-title-cancellation-of-the-contract-changes">4. RETENTION OF TITLE, CANCELLATION OF THE CONTRACT, CHANGES</h3>
        <p className="text-[16px] mb-[5px]">We reserve title to the goods until full payment of the purchase price. In case of behavior contrary to the contract, especially if you fail to meet your payment obligations in spite of a reminder from us, we reserve the right to withdraw from the contract and demand the return of the merchandise held by you within a reasonable given deadline. In this case we are entitled to recycle the returned goods upon their receipt. We reserve the right to decline a contract after a negative result of a credit check. Purchased gift vouchers can not be returned.
        ...
        <h3 className="text-[18px] font-semibold" id="maturity-and-payment">5. MATURITY AND PAYMENT</h3>
        <p className="text-[16px] mb-[5px]">We only accept the methods of payment that were indicated in the framework of the ordering process. The purchase price and any applicable shipping costs are due upon conclusion of the contract.</p>

        <p className="text-[16px] mb-[5px]">Unless otherwise agreed, invoices are payable within 20 days. We may request a prepayment without stating reasons. The order will be processed after receipt of the payment.
        ...
        <p className="text-[16px] mb-[5px]">Reimbursements and deposits are automatically refunded to the Farmy credit account, unless otherwise requested by the customer.</p>

        <p className="text-[16px] mb-[5px]">Vouchers can be redeemed only on the terms indicated on the voucher. It is not permissible to sell coupons or coupon codes without prior written consent from us. When paying with a voucher, any possible remaining balance is credited to the account and automatically credited with the next order.
        The accumulation of actions, coupons and discount codes is not possible.</p>

        <h3 className="text-[18px] font-semibold" id="warranty-and-liability">6. WARRANTY AND LIABILITY</h3>
        <p className="text-[16px] mb-[5px]">If the goods are deficient at the time of delivery, e.g. manufacturer error, or there is a wrong delivery, we will provide a replacement delivery if possible or a reimbursement. 
        ...
        <p className="text-[16px] mb-[5px]">A possibly given consent to the memory of non-finalized orders can be revoked for the future.</p>

        <p className="text-[16px] mb-[5px]"><strong>Location Data</strong></p>

        <p className="text-[16px] mb-[5px]">Our Farmy Fleet App (not available to customers) records the courier location and sends it to our internal company server in order to inform Farmy customers about the approaching delivery updates. We don’t track customer location and don’t share any location data with 3rd parties.</p>

        <p className="text-[16px] mb-[5px]">Creditcheck</p>

        <p className="text-[16px] mb-[5px]">In the course of order closing a creditcheck is executed by Intrum AG. The purpose of this creditcheck is to avoid credit defaults and fraud as well as prevention of over-indebtedness and unauthorized claims. For this purpose required personal information such as name, address, date of birth, contact information (email, telephone number) will be submitted to Intrum AG. Additionally Data of the internet-protocol (IP-Adress, Used Proxy Servers, etc.) will be gathered by using a script and submitted to Intrum AG. Requests for personal information stored by Intrum AG can be raised at Intrum via request for information.</p>

        <p className="text-[16px] mb-[5px]">e-Mail-Marketing</p>

        <p className="text-[16px] mb-[5px]">If you sign up for our newsletter, we will use the information you have provide to send you the newsletter. This agreement can be revoked at any time in the future by unsubscribing from the newsletter.
        ...
        <p className="text-[16px] mb-[50px]">You can find Cembra Pay’s dunning and collection fees under the following link:
